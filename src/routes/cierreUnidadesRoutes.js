...
/**
 * ========================================
 * Endpoints que trabajan con NumeroUnidad
 * ========================================
 */

/**
 * Obtener estado de todas las unidades con un número específico
 * Útil para ver el estado de todas las "Unidad 1" de todos los cursos
 */
 ...
 * Recalcula el estado de todas las "Unidad X" de todos los cursos
 */
 ...
 * Solo administradores, cierra automáticamente todos los cursos que estén listos
 * Body (opcional): { observaciones: string }
 */
